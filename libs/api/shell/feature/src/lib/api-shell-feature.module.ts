...
import { ApiStudentExploreApiFeatureModule as ApiStudentExploreFeatureModule } from '@graduates/api/student-explore/api/feature';
@Module({
  imports: [
    ...
    ApiStudentExploreFeatureModule,
  ],
})
